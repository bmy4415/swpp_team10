...
class Has_coupon(models.Model):
    customer = models.ForeignKey(Customer, related_name='maybe_not_used_1', on_delete=models.CASCADE)
    coupon = models.ForeignKey(Coupon, related_name='maybe_not_used_2', on_delete=models.CASCADE)